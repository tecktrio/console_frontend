...
export default function DocumentationAcademy() {
  return (
    <motion.div animate={{y:1}} initial={{y:100}}>
        
        <Text_Heading_2 text='Academy'/>
        <Text_paragraph_lite text='Widecity Academy is an Ai based learning platform where students can learn what they want with the help of ai.'/>
        <div>
